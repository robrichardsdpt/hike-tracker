  ...
  return(
    ...
    <Modal show={show} onHide={handleClose} className='edit-user-container'>
      ...
      <Modal.Body className='edit-user-body'>
        {user.profileImage ? <div className='user-picture-container'><img className='user-picture' src={user.profileImage}/></div> : <div className='user-picture-container'><img className='user-picture' src={NoPhoto}/></div>}
        <label className='edit-user-label'>Add/Replace picture:</label><br/>
        <input className='edit-user-input' name='profileImage' type="file" onChange={onFileChange} />
      </Modal.Body>
    </Modal>
  </div>
  )
